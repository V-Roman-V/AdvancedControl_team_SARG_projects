...
class CartPoleVisualizer:
    def __init__(self, mode='realtime', cartpole_params: CartPoleParams = None, label_text: str = ""):
        ...
        if self.mode in ['realtime', 'gif']:
            ...
            self.ax_cp.set_xlim(-0.5, 0.5)
            self.ax_cp.set_ylim(-0.2, 0.32)
    ...
    def update(self, state, control, t):
        ...
        self.state_trace_theta.append(self.cartpole_params.l * theta)
        ...
        if self.mode in ['realtime', 'gif']:
            ...
            if self.label_text:
                ...
                self.fig.text(0.945, 0.92, self.label_text.upper(),
                            fontsize=25, color='gray', ha='right', va='top', alpha=0.75,
